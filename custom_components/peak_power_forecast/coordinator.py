...
class PeakPowerForecastCoordinator(DataUpdateCoordinator[dict[str, Any]]):
    ...
    def _publish_forecast_bundle(self, forecast: float) -> None:
        """Publish forecast value plus derived status and color."""
    ...
    async def _async_handle_monthly_event(
        ...
        self._publish_forecast_bundle(self._last_forecast)
    ...
    def _handle_new_sample_direct(self, value: float, now: datetime) -> None:
        ...
        if detect_reset(self.runtime.last_source_value, value):
            self.runtime.previous_quarter_final = self.runtime.current_quarter_max
    ...
    def _recompute(self, value: float, minutes_elapsed: float, *, stale: bool) -> None:
        ...
        self._publish_forecast_bundle(final)
    ...
    def _publish_hold_state(self) -> None:
        ...
        held = max(
            ...
            self.runtime.current_quarter_max,
            self.runtime.previous_quarter_final,
        )
        self._publish_forecast_bundle(held)
